/**
 * The PublicFilmsController file is a very simple one, which does not need to be changed manually,
...
const service = require('../services/PublicFilmsService');
const filmsPublicFilmIdGET = async (request, response) => {
  await Controller.handleRequest(request, response, service.filmsPublicFilmIdGET);
};
...
const filmsPublicGET = async (request, response) => {
  await Controller.handleRequest(request, response, service.filmsPublicGET);
};
